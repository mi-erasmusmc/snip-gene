...
removalColumns = c("EKP_ID", "EKP_Name", "Name", "Gene.start..bp.", "Gene.end..bp.",
                   "Chromosome.scaffold.name", "FC", "FDR", "diff_expression")

f = as.data.frame(fread("Raw data files/Complete feature set generated on 17-06-2019.csv"))
f = f[order(f$Class),]
...
model = train(Class ~ ., data = f, method = "ranger", metric = "ROC", 
